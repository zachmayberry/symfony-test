...
class Artist
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Track", mappedBy="composers", fetch="EXTRA_LAZY")
     *
     * @Serializer\Exclude
     */
    private $composedTracks;
    ...
    public function __construct() {
        ...
        $this->composedTracks = new ArrayCollection();
    }
...
//    /**
//     * @Serializer\VirtualProperty
//     * @Serializer\SerializedName("composedTracks")
//     */
//    public function virtualComposedTracks()
//    {
//        $tracks = array();
//        foreach ($this->getComposedTracks() as $track){
//            $tracks[] = $track->getId();
//        }
//        return $tracks;
//    }
...
//    /**
//     * @Serializer\VirtualProperty
//     * @Serializer\SerializedName("composedTracksCount")
//     */
//    public function virtualComposedTracksCount()
//    {
//        return count($this->composedTracks);
//    }
    ...
    public function getSymptomsString()
    {
        $array = [];
        foreach ($this->getTracks() as $track){
            foreach($track->getSymptoms() as $symptom) {
                if (!in_array($symptom->getTitle(), $array)) {
                    $array[] = $symptom->getTitle();
                }
            }
        }
//        foreach ($this->getComposedTracks() as $track){
...
//        }
     ...
     * @return ArrayCollection
     */
    public function getComposedTracks()
    {
        return $this->composedTracks;
    }

    /**
     * @param ArrayCollection $composedTracks
     */
    public function setComposedTracks($composedTracks)
    {
        $this->composedTracks = $composedTracks;
    }
